...
public class CreateJPanel extends javax.swing.JPanel {
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        ...
        person.setBirth(txtBirth.getText());
        person.setTeleNum(txtTeleNum.getText());
        person.setFaxNum(txtFaxNum.getText());
        person.setEmail(txtEmailNum.getText());
        person.setSsn(txtSSN.getText());
        person.setMedicalNum(txtMedicalNum.getText());
        person.setHealthNum(txtHealthNum.getText());
        person.setBankNum(txtBankNum.getText());
        person.setCertifiNum(txtCertifiNum.getText());
        person.setDeviceNum(txtDeviceNum.getText());
        person.setLinkedln(txtLinkedln.getText());
        person.setInternetAddr(txtInternetAddr.getText());
